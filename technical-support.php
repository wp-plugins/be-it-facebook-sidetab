<?php
/*
Plugin Name: Be-It Support
Plugin URI: http://www.be-it.se/extend/plugins/be-it-support
Description: Tool for Be-It Consulting. Go to dashboard and send a message.
...
/*
    ...
    Be-It Support for WordPress
    Copyright (C) 2011 Be-It Consulting (info@be-it.com)
...
function ts_localize_init ()	{
		$locale = apply_filters('ts',get_locale());
		$mofile = WP_PLUGIN_DIR . '/be-it-support/languages/ts-' . $locale . '.mo';
		load_textdomain('ts', $mofile);
}
add_action ('init', 'ts_localize_init');


function modify_footer_admin () {
  echo 'This WP is tweaked by <a href="http://www.be-it.se/">Be-It Consultning</a>. For removing tweak deactivate Be-It Support tool in plugins.';
}
...
class TechnicalSupport {
	...
	$this->defaultsettings = array(
			"provider_name" => "Be-It Support",
			"provider_email" => "support@be-it.se",
			"provider_logo" => "http://www.be-it.se/wp-content/uploads/2011/11/be-it_logo_33x22.png",
			"provider_url" => "http://www.be-it.se/",
	...
	{
		wp_add_dashboard_widget("technical-support-dashboard", __('Be-It Support', 'ts') , array(&$this, "technical_support"), $control_callback = null);
	}
...
<!--
			<tr>
				...
				<td class="technical-support-right">
					...
					<span class="description"><php _e('Give us a short title of you problem', 'ts');?></span>
				</td>
			</tr>
-->
			<tr>
...
?>
	...
	function admin_menu() {
		add_options_page(__('Technical Support', 'ts'), __('Be-It Support', 'ts'), 'manage_options', __FILE__, array(&$this, 'options'));
	}
...
?>
		<div class="wrap">
		<h2><?php _e('Be-It Support Settings', 'ts');?></h2>

		<p><?php _e('Note that a response e-mail will be sent to the address associated with your profile', 'ts');?> (<a href="mailto:<?php echo $current_user->user_email; ?>"><?php echo $current_user->user_email; ?></a>). <?php _e('In order to change that please visit your', 'ts');?> <a href="profile.php"><?php _e('profile page', 'ts');?></a>.</p>
		<h3><?php _e('To use this plugin please visit the', 'ts');?> <a href="index.php"> <?php _e('dashboard', 'ts');?></a>.</h3>
